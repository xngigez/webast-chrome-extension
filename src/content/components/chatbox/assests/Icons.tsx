		...
		<span dangerouslySetInnerHTML={{
			...
			<svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g id="Menu / Menu_Alt_03">
					<path id="Vector" d="M5 17H13M5 12H19M5 7H13" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				</g>
			</svg>
		`}} />
	);
...
export const AddIcon = () => {
	return (
		<span dangerouslySetInnerHTML={{
			...
			<svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g id="Edit / Add_Plus">
					<path id="Vector" d="M6 12H12M12 12H18M12 12V18M12 12V6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				</g>
			</svg>
		`}} />
	);
